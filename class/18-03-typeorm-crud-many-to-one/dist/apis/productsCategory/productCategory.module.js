...
exports.ProductCateogryModule = void 0;
...
let ProductCateogryModule = class ProductCateogryModule {
};
ProductCateogryModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([productsCategory_entity_1.ProductCategory])],
        providers: [
            productCategory_resolver_1.ProductCateogryResolver,
            productCategory_service_1.ProductCategoryService,
        ],
    })
], ProductCateogryModule);
exports.ProductCateogryModule = ProductCateogryModule;
