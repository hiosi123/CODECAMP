...
let ProductService = class ProductService {
    ...
    async create({ createProductInput }) {
        const { productTags, productSaleslocation, productCategoryId } = createProductInput, rest = __rest(createProductInput, ["productTags", "productSaleslocation", "productCategoryId"]);
        ...
        const result2 = await this.productRepository.save(Object.assign(Object.assign({}, rest), { productSaleslocation: result, productCategory: { id: productCategoryId }, productTags: result3 }));
        return result2;
    }
