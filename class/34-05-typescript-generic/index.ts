// 1. 문자
// 이 arg 는 받을때도 스트링만 받고 나오는 값도 스트링 타입만 나올수 있다. 확인!
...
//
// 2. 숫자
// 위 1번과 동일하다 받을때도 스트링만 받고 나오는 값도 스트링 타입만 나올수 있다. 확인!
...
// 위 1,2 번과 동일하다 받을때도 아무 타입이나 받고 나오는 값도 아무 타입이나 나올수 있다. 확인!
...
// 들어갈때랑 나갈때랑 같아야한다. 똥싸기전이랑 후가 다르면 안된다.
...
const result8 = getGenericReverse<string, number, number>("철수", 3, 8);
console.log(result8);
